...
package object protobuf {
  ...
  sealed abstract class Type(val text: String, imports: Option[String] = None)
  ...
  object Type {
    ...
    case object TIMESTAMP
        extends Type("google.protobuf.Timestamp", imports = Some(""))
  }
  ...
  case class Service(name: String, methods: Seq[Method]) {
    def toProto: String =
      s"""|service $name {
          |  ${methods.map(_.toProto).mkString("\n  ")}
          |}""".stripMargin
  }
